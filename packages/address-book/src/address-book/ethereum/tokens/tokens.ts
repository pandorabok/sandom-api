...
export const tokens = {
  ...
  SAMI: {
    ...
    description:
      "The Sami Token (SAMI) is the governance token of the Sami DAO. Holders of the token are entitled to submit and vote on proposals on all areas affecting the DAO through the Sami Snapshot Space, as well as to participate in Sami's governance incentives programme through the SAMI Pool or SAMI Vault.",
    logoURI: 'https://sami.com/icons/128/SAMI.png',
    bridge: 'native',
  },
  rSAMI: {
    name: 'SAMI Pool Receipt',
    symbol: 'rSAMI',
    oracleId: 'rSAMI',
  ...
  xmooSAMI: {
    name: 'SAMI Vault Receipt xERC20',
    symbol: 'xmooSAMI',
    oracleId: 'xmooSAMI',
  ...
  beQI: {
    ...
    website: 'https://app.mai.finance/',
    description:
      'Sami QI is perpetually lock QI/ETH Balancer Pool Token. QiDao is an overcollateralized stablecoin protocol that allows users to mint stablecoins (MAI) against the value of their decentralized token collaterals. Minting occurs through loans, denomimated in MAI stablecoins. Most loans have 0% interest, meaning the value of the related debt does not change over time.',
    documentation: 'https://docs.mai.finance/introduction-1',
    bridge: 'native',
  },
  USDe: {
