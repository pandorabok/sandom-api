...
export const tokens = {
  ...
  beS: {
    ...
    decimals: 18,
    logoURI: '',
    website: 'https://www.sami.com/',
    description:
      'Sami-escrowed Sonic (beS) is a liquid staking derivative of Sonic (S). It automatically stakes a user’s wS tokens to earn staking rewards. Each beS token represents a proportional share of the staked wS, including any rewards accrued over time. Users can convert beS back to wS with a 14-day unbonding period, or freely trade beS on the open market.',
    documentation: 'https://docs.sami.finance/sami-products/sami-escrowed-tokens/bes',
    bridge: 'native',
  },
  FIVE: {
    name: 'FIVE',
  ...
  beGEMS1: {
    ...
    decimals: 18,
    logoURI: '',
    website: 'https://app.sami.com/campaigns/begems',
    description:
      'beGEMS are a liquid ERC-20 token issued by Sami that represent its share of Sonic Gems airdrop rewards, earned by users through boosting vaults, providing liquidity, or voting for beS pairs across Sonic exchanges.',
    documentation: 'https://docs.sami.com/',
    bridge: 'native',
  },
  STRIKE: {
