...
export const blockedTokensByChain: Record<ApiChain, Set<string>> = {
  bsc: new Set([
    ...
    addressBook.bsc.tokens.oldSAMI.address,
  ...
  heco: new Set([addressBook.heco.tokens.oldSAMI.address]),
  polygon: new Set([
    ...
    addressBook.polygon.tokens.oldSAMI.address,
  ...
  fantom: new Set([
    ...
    addressBook.fantom.tokens.oldSAMI.address,
  ...
  arbitrum: new Set([
    ...
    addressBook.arbitrum.tokens.oldSAMI.address,
  ]),
  celo: new Set([addressBook.celo.tokens.oldSAMI.address]),
  moonriver: new Set([addressBook.moonriver.tokens.oldSAMI.address]),
  cronos: new Set([
    ...
    addressBook.cronos.tokens.oldSAMI.address,
  ...
  aurora: new Set([
    ...
    addressBook.aurora.tokens.oldSAMI.address,
  ]),
  fuse: new Set([addressBook.fuse.tokens.oldSAMI.address]),
  metis: new Set([addressBook.metis.tokens.oldSAMI.address]),
  moonbeam: new Set([addressBook.moonbeam.tokens.oldSAMI.address]),
  emerald: new Set([addressBook.emerald.tokens.oldSAMI.address]),
  optimism: new Set([
    ...
    addressBook.optimism.tokens.oldSAMI.address,
    addressBook.optimism.tokens.pETHo.address,
    addressBook.optimism.tokens.sETHo.address,
  ]),
  kava: new Set([addressBook.kava.tokens.oldSAMI.address]),
  ethereum: new Set([
    ...
    addressBook.ethereum.tokens.oldSAMI.address,
    addressBook.ethereum.tokens.pETH.address,
  ]),
  canto: new Set([addressBook.canto.tokens.oldSAMI.address]),
  zksync: new Set([addressBook.zksync.tokens.oldSAMI.address]),
  zkevm: new Set([]),
  base: new Set([]),
  gnosis: new Set([]),
  linea: new Set([]),
